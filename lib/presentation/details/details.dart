...
import 'package:space_square/domain/planet_model.dart';
import '../gallery_image/gallery_image.dart';
import 'package:font_awesome_flutter/font_awesome_flutter.dart';

class PlanetDetails extends StatefulWidget {
  const PlanetDetails({Key? key, this.image, this.index, required this.planet})
      : super(key: key);
